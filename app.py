...
@app.route('/about')
def about():
    about_text = "НЕБОГРАЙ – це досвідчена команда з ремонту терміналів супутникового зв’язку “STARLINK”. Наша компанія працює вже більше року та має великий досвід у ремонті та модернізації терміналів “STARLINK”."  # Закрито лапку!
